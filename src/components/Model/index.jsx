      ...
      >
        ...
        <div className='text-center'>
          ...
          <p className='Paragraphs opacity-75 max-w-3xl m-auto'>
            ...
            with the MSI GF65 Thin 10UE-213. This
            high-performance laptop is designed for gamers
            and power users who demand the best. Featuring
            cutting-edge technology and sleek aesthetics, it
            is the perfect companion for both work and play.
          </p>
        </div>
      </div>
    </section>
